...
enum rule_name {
        S1P1P1,S2P1P1,S2P1P1_1, S2P1P1_2, S3P1P1,S1DFP1,S2DFP1,S3DFP1,
        E1P1DF,E2P1DF,E1DFP1,E1DNP1,E1DDP1,R1P1,S1DFP2,S1P1P2,
        ...
        S1M1M2,R2M2,W2P1,W2DF,W2V2,S1M1M1,S2M1M1,S3M1M1,E1M2V2,S1CTCT,S2CTCT,S3CTCT,
        E1INDF, E1IPDF,
        E1INGA, E1IPGA, 
        E1WNDP,S1DNWN, S2M2M2,
        A1M1, W1M1,W1M2,W1M3,W1M4,W1M5,
        W1M6,W1M7,W1M8,W1M9,W1M10,A1DF,
        S1DFDF, S2DFDF,S1VIVI,S1V2V2,S1M3M3,
...
public:
        ...
        string getLayerName(int i){
                return layer_labels_lst[i].name;
        };
...
private:
        ...
        trules rules_lst[N_RULES] = {
                ...
                {"E1INGA","Minimum NPLUS extension of GATE",0},
                {"E1IPGA","Minimum PPLUS extension of GATE",0},
