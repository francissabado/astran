...
public:
        ...
        void setTopCell(string cellName){
                topCell=cellName;
        };
        string getTopCell(){
                return topCell;
        };
        void setVddNet(string s){
                vddNet=s;
        };
        string getVddNet(){
                return vddNet;
        };
        void setGndNet(string s){
                gndNet=s;
        };
        string getGndNet(){
                return gndNet;
        ...
        void setHGridOffset(bool x){
                hGridOffset=x;
        };
        bool getHGridOffset(){
                return hGridOffset;
        };
        void setVGridOffset(bool x){
                vGridOffset=x;
        };
        bool getVGridOffset(){
                return vGridOffset;
        };
        void setHPitch(float x){
                hGrid=x;
        };
        float getHPitch(){
                return hGrid;
        };
        void setVPitch(float x){
                vGrid=x;
        };
        float getVPitch(){
                return vGrid;
        };
        void setSupplyVSize(float x){
                supplyVSize=x;
        };
        float getSupplyVSize(){
                return supplyVSize;
        };
        void setnWellPos(float x){
                nWellPos=x;
        };
        float getnWellPos(){
                return nWellPos;
        };
        void setnWellBorder(float x){
                nWellBorder=x;
        };
        float getnWellBorder(){
                return nWellBorder;
        };
        void setpnSelBorder(float x){
                pnSelBorder=x;
        };
        float getpnSelBorder(){
                return pnSelBorder;
        };
        void setCellTemplate(string x){
                cellTemplate=x;
        };
        string getCellTemplate(){
                return cellTemplate;
        };
        ...
        map<string, CellNetlst>* getCellNetlsts(){
                return &cellNetlsts;
        };
        map<string, string>* getEquations(){
                return &equations;
        };
        void setCellsHeight(unsigned int h) {
                cellsHeight=h;
        };
