...
public:
        ...
        struct t_trace {
                ...
                bool visited;
                void clear(){
                        father=-1; visited=false;
                };
                void setFather(int f, t_arc* l){
                        link=l; father=f; visited=true;
                };
        };
...
public:
        ...
        int getNet(unsigned int node){
                return graph[node].net;
        };
        int getNrNets(unsigned int node){
                return graph[node].nrNets;
        };
        list<unsigned int>* getNetNodes(unsigned int net){
                return &netlist[net].nodes;
        };
