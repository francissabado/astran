...
protected:
        ...
        virtual void PressedKey( wxKeyEvent& event ) {
                event.Skip();
        }
        virtual void newDesign( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void newCell( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void loadProject( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void loadTech( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void loadSpiceNetlist( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void loadLayouts( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void loadPlacement( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void loadRouting( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void saveProject( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void saveTech( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void saveSpiceNetlist( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void saveLayouts( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void savePlacement( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void saveRouting( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void importSpiceNetlist( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void importLEF( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void exportLayout( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void exportCellSizes( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void exportPlacement( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void flReadScript( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void saveHistory( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void OnFileExit( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void showTech( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void showCircuit( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void showPreferences( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void sizeFO4( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void sizeGP( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void elmoreDelay( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void showCellgen( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void calcPinsPos( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void showFP( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void plTerminals( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void fastp( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void plVerify( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void plAutoFlip( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void plIncremental( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void plWL( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void rotdl( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void pfinder( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void rtOptimize( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void rtCompact( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void rtClear( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void HelpaboutClick( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void helpHP( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void refreshIcon( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void layoutListEvent( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void viewLayout( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void openInstancewindow( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void printInstance( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void printCell( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void printNet( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void printInterface( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void CmdKeyDown( wxKeyEvent& event ) {
                event.Skip();
        }
...
protected:
        ...
        // Virtual event handlers, overide them in your derived class
        virtual void hide( wxCloseEvent& event ) {
                event.Skip();
        }
        virtual void PressedKey( wxKeyEvent& event ) {
                event.Skip();
        }
        virtual void okButtonEvt( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void cancelButtonEvt( wxCommandEvent& event ) {
                event.Skip();
        }
...
protected:
        ...
        virtual void generateCell( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void select( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void fold( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void place( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void route( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void compact( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void view( wxCommandEvent& event ) {
                event.Skip();
        }
...
protected:
        ...
        virtual void applyButtonEvt( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void okButtonEvt( wxCommandEvent& event ) {
                event.Skip();
...
protected:
        ...
        virtual void plButton( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void rotdlButton( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void viewerButton( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void lpsolverButton( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void logButton( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void okButtonEvt( wxCommandEvent& event ) {
                event.Skip();
...
protected:
        ...
        virtual void selectRule( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void selectLayer( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void saveButtonEvt( wxCommandEvent& event ) {
                event.Skip();
        }
        virtual void closeButtonEvt( wxCommandEvent& event ) {
                event.Skip();
        }
