...
public:
        ...
        IOType getIOType(int net){
                return inouts_type[net];
        };
        void appendNetNameSuffix(string n);
        string& getNetName(int n){
                return nets[n].name;
        };
        ...
        map<string,CellInstance>& getInstances(){
                return instances;
        };
        bool check();
        ...
        vector<TransitorTerminal>& getOrderingP(){
                return orderingP;
        };
        vector<TransitorTerminal>& getOrderingN(){
                return orderingN;
        };
        void setOrderingP(vector<TransitorTerminal>& ordering){
                orderingP=ordering;
        };
        void setOrderingN(vector<TransitorTerminal>& ordering){
                orderingN=ordering;
        };
